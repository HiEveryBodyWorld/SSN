...
public class RedisCacheUtil<T> {
     ...
     * @param key        缓存键值
     */
	public void deleteCacheListObject(List<String> keys){
		redisTemplate.delete(keys);;
	}
	
	public <T> Boolean expiredCache(T key,int outTime){
		return redisTemplate.expire(key, outTime, TimeUnit.MILLISECONDS);
