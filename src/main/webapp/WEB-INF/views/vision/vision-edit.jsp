...
<article class="page-container">
	<form class="form form-horizontal" id="form-vision-edit">
	<input name="id" type="hidden" value='${vision.id}'>
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>版本号：</label>
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="${vision.visionCode}"  id="visionCode" name="visionCode">
		</div>
	</div>
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>版本链接：</label>
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="${vision.url}" placeholder="" id="url" name="url" >
		</div>
	</div>
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>版本描述：</label>
		<div class="formControls col-xs-8 col-sm-9">
				<textarea id="describtion" name="describtion" cols="" rows="" class="textarea"  placeholder="说点什么...最少输入10个字符" datatype="*10-100" dragonfly="true" nullmsg="备注不能为空！" onKeyUp="$.Huitextarealength(this,200)">${vision.describtion}
				</textarea>
...
$(function(){
	...
	$("#form-vision-edit").validate({
		...
		submitHandler:function(form){
			var url ='/sys/vision/update';
			$(form).ajaxSubmit({
				type: 'post',
				url: url ,
				success: function(data){
						layer.msg('修改成功!',{icon:1,time:10000});
