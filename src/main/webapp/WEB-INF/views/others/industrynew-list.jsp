...
<form id="list_form" action="/sys/industrynew/tolist" method="post">
	<div class="text-c">
	 	日期范围：
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"> <a class="btn btn-primary radius" data-title="添加新闻" data-href="/sys/industrynew/toadd" onclick="Hui_admin_tab(this)" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加业内新闻</a></span> </div>
	<div class="mt-20">
