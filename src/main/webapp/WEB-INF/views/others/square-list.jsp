...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 广场学堂管理 <span class="c-gray en">&gt;</span> 广场学堂列表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
<form id="list_form" action="/sys/square/tolist" method="post">
	<div class="text-c">
	 	日期范围：
		...
		<input type="text" name="title" id="" placeholder=" 学堂名称" style="width:250px" class="input-text">
		<button name="search_news" id="search_news" class="btn btn-success" type="submit"><i class="Hui-iconfont">&#xe665;</i> 搜广场学堂</button>
	</div>
</form>
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"> <a class="btn btn-primary radius" data-title="添加新闻" data-href="/sys/square/toadd" onclick="Hui_admin_tab(this)" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加广场学堂</a></span> </div>
	<div class="mt-20">
