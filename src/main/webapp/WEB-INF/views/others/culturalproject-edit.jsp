...
<link href="<%=request.getContextPath() %>/resources/js/webuploader/0.1.5/webuploader.css" rel="stylesheet" type="text/css" />
<!--[if IE 6]>
...
<title>新增文章 - 资讯管理 - H-ui.admin v3.0
</title>
...
<article class="page-container">
	<form class="form form-horizontal" id="form-article-add">
		<input id="manageId" name="id" type="hidden" value='${others.manageId}'>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>文创项目标题：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${others.title}" placeholder="" id="articletitle" name="articletitle">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">文创项目副标题：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${others.subtitle}" placeholder="" id="articletitle2" name="articletitle2">
			</div>
		</div>
		
		
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">文创项目附属信息：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<textarea id="comment" name="abstract" cols="" rows="" class="textarea"  placeholder="说点什么...最少输入10个字符" datatype="*10-100" dragonfly="true" nullmsg="备注不能为空！" onKeyUp="$.Huitextarealength(this,200)">${others.comment}
				</textarea>
				<p class="textarea-numberbar"><em class="textarea-length">0</em>/200</p>
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">上传过的图片：</label>
			<div class="formControls col-xs-8 col-sm-9">
			<div class="portfolio-content">
			<ul class="cl portfolio-area line bk-gray">
			<c:forEach var="image" items="${images}" varStatus="vs">
				<li class="item">
					<div class="portfoliobox">
						<input class="checkbox" name="isselect" type="checkbox" value="${image.imageId}">
						<div class="picbox">
							<a href="${image.url}" data-lightbox="gallery"><img src="${image.url}" width="300" height="300"></a>
						</div>
					</div>
				</li>
			</c:forEach>
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">文创项目内容：</label>
			<div class="formControls col-xs-8 col-sm-9"> 
				<script id="editor" type="text/plain" style="width:100%;height:400px;"></script> 
			</div>
		</div>
		<input id="showContent" name="id" type="hidden" value='${others.content}'>
		<div class="row cl">
...
(function( $ ){
    ...
    $(function() {
        ...
        uploader = WebUploader.create({
            ...
            dnd: '#dndArea',
            paste: '#uploader',
            swf: '<%=request.getContextPath()%>/resources/js/webuploader/0.1.5/Uploader.swf',
            chunked: false,
            chunkSize: 512 * 1024,
            server: '<%=request.getContextPath()%>/sys/others/upload',
            ...
            if ( file.getStatus() === 'invalid' ) {
                ...
                uploader.makeThumb( file, function( error, src ) {
                    ...
                    if( isSupportBase64 ) {
                        ...
                        $.ajax('<%=request.getContextPath()%>/resources/js/webuploader/0.1.5/server/preview.php', {
                            method: 'POST',
                            data: src,
                            dataType:'json'
...
$(function(){
	...
	$("#form-article-add").validate({
		...
		submitHandler:function(form){
			...
			jQuery.ajax({
		        type : 'POST',
		        url : '<%=request.getContextPath()%>/sys/others/update',
...
function datadel(){
	...
	layer.confirm('确认要删除所选吗？',function(index){
		...
		var url ='/sys/image/delImages/'+ids
		jQuery.ajax({
	        type : 'POST',
	        contentType : 'application/json',
	        url : url,
