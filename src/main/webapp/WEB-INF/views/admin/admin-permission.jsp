...
<div class="Hui-article">
		<article class="cl pd-20">
			...
			<div class="cl pd-5 bg-1 bk-gray mt-20">
				<span class="l">
				<a href="javascript:;" onclick="admin_add('添加权限','toadd','800','500')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加权限</a>
				</span>
			</div>
			<div class="mt-10">
			<table class="table table-border table-bordered table-bg table-sort">
				<thead>
					...
					<tr class="text-c">
						...
						<th width="90">权限类型</th>
						<th width="150">权限父级</th>
						<th width="150">权限路径</th>
						<th width="100">操作</th>
					</tr>
				</thead>
				<tbody>
